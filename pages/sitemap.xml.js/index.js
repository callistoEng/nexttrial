const BASE_URL = "http://localhost:3000"; //This is where you will define your base url.
//You can also use the default dev url http://localhost:3000
...
export const getServerSideProps = async ({ res }) => {
  ...
  const blogs = await getRandomPosts(); // your custom API call
  ...
  const dynamicPaths = blogs.map((singleBlog) => {
    return `${BASE_URL}/news/more/${singleBlog.slug}`;
  });
