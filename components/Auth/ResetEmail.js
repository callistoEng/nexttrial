...
import { reset_email } from "../../state/actionCreators/auth";
...
const ResetEmail = () => {
  ...
  useEffect(()=>{
    TrackpageView("/auth/reset-email")
  },[])
  
  const onSubmit = (e) => {
    e.preventDefault();
    dispatch(reset_email(email));
  };
  return (
    <section className="p-4 w-1/2 mx-auto">
      ...
      <div className="mt-4 text-center">
        <h2 className="font-bold">Reset Email</h2>
        <p>Enter your current email address below to change email</p>
      </div>
